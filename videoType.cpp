...
void videoType::printTile() const
{
...
void videoType::printInfo() const
{
    ...
    cout << "Production : " << movieProductionCo << endl;
    cout << "Copies in stock : " << copiesInStock << endl;
}

bool videoType::checkTitle(strilg title)
{
    return(videoTitle == tittle);
}
